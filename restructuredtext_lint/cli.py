...
def _main(filepath, format='text', stream=sys.stdout, encoding='ascii'):
...
def main():
    ...
    parser.add_argument('--encoding', type=str, help='Encoding of the input file (e.g. utf-8)', default='ascii')
